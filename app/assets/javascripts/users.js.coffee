...
jQuery ->
  ...
  $("#ad").ready ->      
    ...
    $('#password_fields > .field > input#user_password').val('dummy')
    $('#password_fields > .field > input#user_password_confirmation').val('dummy')
  ...
  $("#ad").change ->
    if $("#ad:checked").is(':checked')
      ...
      $('#no_ad_fields > .field > input#user_name').val('')
      $('#no_ad_fields > .field > input#user_username').val('')
      $('#no_ad_fields > .field > input#user_email').val('')
      $('#password_fields > .field > input#user_password').val('')
      $('#password_fields > .field > input#user_password_confirmation').val('')
      $('#ad_selectors').hide()
